...
export default class Quake {
  constructor() {
    this.baseUrl =
      "https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2022-11-14&endtime=2022-11-16";
  ...
  async getEarthQuakesByRadius(position, radius = 3000) {
